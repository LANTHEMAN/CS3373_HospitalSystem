...
public class HomeController implements SwitchableController, Observer {
    ...
    ComboBox filterType;
    @FXML
    ComboBox availableTypes;
    @FXML
    TableView<ServiceRequest> searchResultTable;
    @FXML
    TableColumn btnsCol;
    @FXML
    TableColumn<ServiceRequest, Integer> idNumberCol;
    @FXML
    TableColumn<ServiceRequest, String> requestTypeCol;
    @FXML
    TableColumn<ServiceRequest, String> firstNameCol;
    @FXML
    TableColumn<ServiceRequest, String> lastNameCol;
    @FXML
    TableColumn<ServiceRequest, String> destinationCol;
    @FXML
    TableColumn<ServiceRequest, Integer> requestPriorityCol;
    @FXML
    TableColumn<ServiceRequest, String> theStatusCol;
    @FXML
    Label typeLabel;
    @FXML
    Label idLabel;
    ...
    ComboBox statusBox;
    @FXML
    Label completedByLabel;
    @FXML
    Label usernameLabel;
    @FXML
    TableColumn chooseCol;
    @FXML
    TableColumn<User, String> usernameCol;
    @FXML
    TableColumn<User, String> firstNameUserCol;
    @FXML
    TableColumn<User, String> lastNameUserCol;
    @FXML
    TableColumn<User, String> privilegeCol;
    @FXML
    TableColumn<User, String> occupationCol;
    ...
    JFXButton aStar;
    @FXML
    JFXButton depthFirst;
    @FXML
    JFXButton breathFirst;
    ...
    @FXML
    TableView<User> searchUserResultTable;
    ...
    @FXML
    public void onCancelDirectionsEvent() {
    ...
    @FXML
    public void setCancelMenuEvent() {
